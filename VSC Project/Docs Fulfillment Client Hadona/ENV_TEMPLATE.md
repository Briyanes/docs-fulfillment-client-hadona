...
NEXT_PUBLIC_SUPABASE_URL=https://pdamwotvomagbnphilby.supabase.co
...
1. **NEXT_PUBLIC_SUPABASE_URL**
   - Value: `https://pdamwotvomagbnphilby.supabase.co`
...
2. Pilih project dengan URL: `pdamwotvomagbnphilby.supabase.co`
