export default function HelpAndFollow() {
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8" style={{ backgroundColor: '#ffffff' }}>
      <div className="grid gap-4 md:grid-cols-5">
        {/* Need Help Card - 20% */}
        <div className="rounded-lg bg-hadona-primary p-4 shadow-sm md:col-span-1">
          <h3 className="mb-4 text-base font-bold text-white">Need Help?</h3>
          <div>
            {/* WhatsApp */}
            <a 
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm md:col-span-4">
          ...
          <div className="hidden md:flex flex-wrap gap-4">
            ...
            >
              ...
              <div>
                <p className="font-semibold text-sm text-gray-900">Social Media</p>
