...
export const metadata: Metadata = {
  ...
  keywords: ['utm medium', 'utm', 'tracking parameter', 'analytics', 'whitelist', 'hadona', 'client whitelist'],
  openGraph: {
    title: 'Parameter utm_medium | Hadona Docs',
    description: 'Panduan parameter utm_medium untuk tracking medium marketing',
    url: 'https://docs.hadona.id/whitelist/utm-configuration/utm-medium',
  },
}
